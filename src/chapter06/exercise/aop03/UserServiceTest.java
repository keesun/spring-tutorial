...
public class UserServiceTest {
	...
	public void upgradeAllOrNothing() throws Exception {
		...
		th.setTarget(testUserService);
		th.setTransactionManager(transactionManager);
		th.setPattern("upgradeLevels");
		UserService userServiceTx = (UserService) Proxy.newProxyInstance(getClass().getClassLoader(), new Class[]{UserService.class}, th);
